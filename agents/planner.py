        ...
        *,
        ...
        return await self.base.generate_json(
            ...
            system_instruction=(
                ...
                "Analyze the developer request and plan a complete implementation. For a "
                "full-stack request, explicitly cover the frontend, backend/API, database "
                "schema and access layer, environment configuration, deployment configuration, "
                "and tests; do not reduce it to a static HTML mock unless requested. "
                ...
                "List every required environment variable in environment_variables with its "
                "purpose; mark secret=true for passwords, tokens, API keys, OAuth credentials, "
                "SMTP credentials, and database URLs. Do not request a normal Gmail password "
                "when an app password or OAuth credential is the appropriate safer choice. "
